...
<td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                                <div class="imgpop">
                                                     <a href="#"><img src="http://images.servisso.com/emails/logo_email.png" width="100" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo" id="nsn1vloysree9udi"></a>
                                                </div>
                                            </td>
                                        </tr></tbody></table>
...
<td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #95a5a6; text-align:center;line-height: 30px;" st-content="fulltext-paragraph">
                                                <p>
                                                    El siguiente paso es verificar tu correo electrónico. Por favor, da clic en el siguiente botón, con esto confirmaremos que el correo que proporcionaste es tuyo.
                                                </p>
                                            </td>
                                        </tr>
...
<td style="padding-left:18px; padding-right:18px;font-family:Helvetica, arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300;" width="auto" align="center" valign="middle" height="36">
                                                                 ...
                                                                 <a style="color: #ffffff; text-align:center;text-decoration: none;" href="{{ $baseUrl }}/email/confirmar/{{$code}}" st-content="download" tabindex="-1"><span style="color: #ffffff; font-weight: 300;"> Confirmar</span></a>
                                                            </td>
                                                        </tr></tbody></table>
</td>
                                        </tr>
